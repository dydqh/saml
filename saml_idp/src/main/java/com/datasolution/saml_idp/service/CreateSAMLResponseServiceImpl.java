...
@Service
public class CreateSAMLResponseServiceImpl implements CreateSAMLResponseService {

	private String privateKeyLocation;
	private String publicKeyLocation;

	@Override
	public Response createResponse(final DateTime issueDate, Issuer issuer, Status status, Assertion assertion) {
	...
	@Override
	public Assertion createAssertion(final DateTime issueDate, Subject subject, Issuer issuer,
	...
	@Override
	public Issuer createIssuer(final String issuerName) {
	...
	@Override
	public Subject createSubject(final String subjectId, final Integer samlAssertionDays) {
	...
	@Override
	public AuthnStatement createAuthnStatement(final DateTime issueDate) {
	...
	@Override
	public AttributeStatement createAttributeStatement(HashMap<String, List<String>> attributes) {
